...
// task2
// let num1 = prompt('type number1');
// let num2 = prompt('type number2');
// num1 = Number(num1);
// num2 = Number(num2);
// let sum = num1 + num2;
// console.log(sum);
...
// task10
// let numFirst = 9;
// console.log(Math.sqrt(numFirst));
